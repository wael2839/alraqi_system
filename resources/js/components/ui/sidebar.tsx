...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">إظهار/إخفاء الشريط الجانبي</span>
    </Button>
  )
}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 rtl:md:peer-data-[variant=inset]:me-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-0 rtl:md:peer-data-[variant=inset]:peer-data-[state=collapsed]:me-0",
        className
      )}
      {...props}
    />
