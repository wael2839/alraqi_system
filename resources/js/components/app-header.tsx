        ...
        <>
                                ...
                                {mainNavItems.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        {isCurrentUrl(item.href) && (
                                            <div className="absolute bottom-0 start-0 h-0.5 w-full translate-y-px bg-black dark:bg-white"></div>
                                        )}
                                    </NavigationMenuItem>
                                ))}
                            </NavigationMenuList>
                                ...
                                >
                                    <Avatar className="size-8 overflow-hidden rounded-full">
                                        ...
                                        <AvatarFallback className="rounded-lg bg-neutral-200 text-black dark:bg-neutral-700 dark:text-white">
                                            {getInitials(auth.user.name ?? auth.user.displayName)}
                                        </AvatarFallback>
                                    </Avatar>
                                </Button>
                            </DropdownMenuTrigger>
            ...
            {breadcrumbs.length > 1 && (
                <div className="flex w-full border-b border-sidebar-border/70">
                    <div className="mx-auto flex h-12 w-full items-center justify-end px-4 text-neutral-500 md:max-w-7xl">
